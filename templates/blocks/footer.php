        ...
        <div class="grid-container">
          <div class="grid-x">
            <div class="footer_nav">
              <div class="footer_logo"><a href="index.php">Бытовки-Сервис.ru</a></div>
        ...
        <div class="grid-container">
          <div class="grid-x">
            ...
            <div class="footer_info">
              <div class="footer_address"><i class="icon-address"></i>ул. Молодогвардейская, д. 58, стр.13, офис 28.<br>Мы работаем: Пн - Пт с <?php echo"$time"?></div>
