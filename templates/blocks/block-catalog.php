          ...
          <div class="grid-container">
            <div class="preview_bytovka-item">
              <div class="preview_bytovka-main">
                ...
                <div class="preview_bytovka-content"><a class="preview_bytovka-heading" href="#"><?php echo  $item_title ;?></a>
                  <div class="preview_bytovka-gabarits"><?php echo  $item_size;?></div>
                  ...
                  <div class="preview_bytovka-order">
                    <div class="preview_bytovka-price">Цена: <span><?php echo $item_price;?></span></div>
