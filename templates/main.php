  ...
  <?php require_once 'blocks/mob.php'?>  
    <main>
      ...
      <?php
        ...
        foreach($item_catal as $key => $value){
          ...
          include ('blocks/block-catalog.php');   
        } 
        ?>
      <div class="main_map">
        <div class="grid-container">
      ...
      <?php require_once 'blocks/calc.php'?>
      ...
      <?php require_once 'blocks/main_phot.php'?>
      <div class="price">
        <div class="grid-container">
          ...
          <?php 
            ...
            foreach ($item_rent as $key => $value){
              ...
              include ('blocks/block_prise.php');              
            }
      ...
      <?php require_once 'blocks/del_calc.php'?>
